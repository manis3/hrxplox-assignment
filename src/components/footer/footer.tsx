...
export default function Footer() {
  return (
    <footer className="bg-background mt-24">
      <div className="max-w-[1300px] mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 flex flex-col lg:flex-row gap-4">
        <div className="flex flex-col gap-3 lg:w-1/4">
          <Slogan />
          <p className="text-base">Unlock Your Business Potential with Customized Solutions</p>
        </div>
