    ...
    return (
        <div className={cn(className)}>
            <h1 className='text-2xl sm:text-3xl font-bold'>
                Hyaluronic Acid Serum</h1>
            <div className="relative !flex !flex-row items-center gap-2 mt-3 ">
                <p>No of stock</p>
                <span className={cn('py-1 px-2  rounded-md font-medium', {
            ...
            <div className='mt-10'>
                <Button variant={"secondary"} className='rounded-full bg-[] text-text-primary hover:opacity-90 transition-all duration-300' onClick={() => setProductCount(productCount + 1)}> {title}</Button>
            </div>
            <div className='mt-8'>
